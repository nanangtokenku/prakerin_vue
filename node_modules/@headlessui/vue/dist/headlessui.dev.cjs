...
var Dialog = (0, import_vue23.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    useInertOthers(internalDialogRef, (0, import_vue23.computed)(() => hasNestedDialogs.value ? enabled.value : false));
    useStackProvider({
      type: "Dialog",
    ...
    }, (0, import_vue23.computed)(() => dialogState.value === 0 /* Open */ && !hasNestedDialogs.value));
